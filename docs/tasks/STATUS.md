...
| **22** | **Durable pause/resume + verified checkpoints** | [WS-22](WS-22-pause-resume.md) | in review | `codex/pause-resume` | implementation complete; unit/race/lint/coverage/assets/frontend/native desktop, kind chaos, both keyless egress modes, and live Codex pause/resume green — awaiting required PR CI |
